...
- If the issue changes user-facing behavior or adds a new feature, keep the matching `Docs/site` update in the same issue scope rather than treating docs as an optional later task.
...
- Verify that any user-visible feature, workflow, onboarding, or settings change also updated the matching page in `Docs/site`.
